    ...
    return(
        <div className="bg-purple h-[57rem] -mx-[20px] md:-mx-[120px] -my-[30px]">
            <div className="px-[60px] py-[30px]">
                ...
                <img className="mx-auto mt-20" src={landingImage}/>
            </div>
            <div className="grid xl:grid-cols-2">
                <div className="relative mx-auto">
                    <img className="mx-auto w-[35rem] xl:w-[42rem] xl:mx-none" src={textBubble}/>
                    <div className="absolute inset-0 flex items-center justify-center mb-20 mr-6">
                        <img className="w-28 border-black rounded-full border-[12px] mr-4" src={promoIcon}/>
                ...
                <div className="relative mx-auto">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center mb-20 mr-4">
                        <img className="w-28 border-black rounded-full border-[12px] mr-4" src={postIcon}/>
